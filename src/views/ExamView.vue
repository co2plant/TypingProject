<template>
  <div class="container mx-auto px-4 py-8">
    <div v-if="exam">
      ...
      <div v-else>
        <div v-if="examPhase === 'quiz'" class="max-w-3xl mx-auto">
            ...
            <div class="mb-6">
              ...
              <div class="space-y-3">
                <div 
                  ...
                  :class="{
                    'p-3 rounded-md cursor-pointer border-2 transition-colors': true,
                    'border-primary-500 bg-primary-100': selectedAnswer === option,
                    'border-gray-200 hover:border-primary-300 hover:bg-primary-50': selectedAnswer !== option
                  }"
                >
                  <span>{{ option }}</span>
                </div>
