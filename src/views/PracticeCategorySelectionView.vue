    ...
    <div class="max-w-3xl mx-auto my-8 px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="flex justify-between items-center mt-4">
                ...
                {{ getCategoryQuestionCount(category) }}개의 지식
                </span>
...
const selectCategory = (categoryName) => {
    router.push({ name: 'practice-category-content', params: { categoryName: encodeURIComponent(categoryName) } })
}

const getCategoryQuestionCount = (category) => {
  return typingContents.filter(contents => contents.category === category).length
}
